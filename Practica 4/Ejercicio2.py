...
if len(letter)>1 or len(letter)==0:#If que comparará el contenido de la variabke letra con la condición impuesta(que le contenido de la variable sea los de uncaracter)
