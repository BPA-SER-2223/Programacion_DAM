...
def get_grades(list_grades):#No puedo importar la lista de notas directamente aqui, por lo tanto lo importo en el archivo donde voy a ejecutar el método y almaceno en una variable inicializada en el parentesis de llamada
